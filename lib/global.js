...
// Clerk SDK 按需加载:未配置 NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY 时
// @clerk/nextjs 完全不进入客户端 bundle
const ClerkUserBridge = dynamic(() => import('@/lib/clerk/ClerkUserBridge'), {
  ssr: false
})
...
export function GlobalContextProvider(props) {
  ...
  return (
    <GlobalContext.Provider
      value={contextValue}>
      {enableClerk && <ClerkUserBridge onChange={setClerkUser} />}
      {children}
    </GlobalContext.Provider>
  )
}
