...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Alan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '藏蓝', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://120.24.237.44/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '公安联考, 郑州警察学院', // 网站关键词 英文逗号隔开
